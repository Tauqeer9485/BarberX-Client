  ...
  return (
    <section className="relative bg-white py-12 px-4 md:px-[94px] w-full max-w-[90vw] mx-auto">
      ...
      <h2 className="text-center text-[#353535] font-semibold text-[26px] md:text-[48px] leading-tight mb-10 md:mb-14">
        Top rated salons at <span className="text-[#BB23DA]">BarberX</span>
      </h2>

      <div className="md:h-[350px] overflow-hidden">
        <div 
          ref={scrollRef}
          className="max-h-[880px] md:max-h-none md:h-[400px] overflow-y-auto md:overflow-x-auto scrollbar-hide"
        >
          <div className="flex flex-col md:flex-row gap-4 md:gap-5 lg:gap-6 ml-[1.5vw]">
            <ServiceCard />
            <ServiceCard />
            <ServiceCard />
            <ServiceCard />
...
const ServiceCard = () => {
  ...
  return (
    <div 
      className="snap-start flex-shrink-0  max-w-[80vw] md:w-[34vw] lg:w-[25vw]  bg-white border border-[#A0A0A0] rounded-md p-2 md:p-4"
    >
      <div onClick={() => router.push("/salons")} >
        {/* Image */}
